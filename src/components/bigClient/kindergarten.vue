<template>
  ...
  <div class="container" style="height: 800px;overflow-y: scroll">
    ...
    <el-row style="margin-top: 20px;">
      ...
      <el-col :span="3">
        <el-select size="small" clearable  v-model="search.quarter">
      ...
      <el-col :span="3">
        <el-select size="small" clearable  v-model="search.feedbackTypeValue">
          <el-option v-for="item in feedbackType" :key="item.zoom" :value="item.zoom" :label="item.type"></el-option>
        </el-select>
      </el-col>
      <el-col :span="2" class="text-four">
        <span>反馈内容:</span>
      ...
      <el-col :span="2" style="width: 105px;line-height: 30px;margin-left: 1%">
        <span>是否需要车辆:</span>
      </el-col>
      <el-col :span="2">
        <el-select size="small" clearable  v-model="search.isNeedCar">
          <el-option v-for="item in searchCar" :key="item.zoom" :value="item.zoom" :label="item.type"></el-option>
        </el-select>
      </el-col>
    ...
    <el-row style="margin-top: 20px;">
      ...
      <el-col :span="2" style="width:150px;line-height: 30px;margin-left:1%;">
        <span>查体开始时间范围：</span>
      </el-col>
      <el-col :span="5">
        <el-date-picker
    ...
    >
      <el-row>
        ...
        <el-col :span="3" style="line-height: 30px;margin-left:2%;">
          <span class="after-red">城&nbsp;&nbsp;&nbsp;&nbsp;市:</span>
        </el-col>
        <el-col :span="6">
          <el-select
            size="small"
      ...
      <el-row style="margin-top: 20px;">
        ...
        <el-col :span="6" >
          <el-input v-model="modifySelection.linkPeople" disabled placeholder="自动获取" size="small"></el-input>
        </el-col>
        <el-col :span="3" style="line-height: 30px;margin-left: 2%">
          <span>对接人电话:</span>
        </el-col>
        <el-col :span="6" >
          <el-input v-model="modifySelection.linkPhone" disabled placeholder="自动获取" size="small"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">负责部门:</span>
        </el-col>
        <el-col :span="6" >
          <el-input v-model="modifySelection.chargeDepart" placeholder="请输入部门" size="small"></el-input>
        </el-col>
        <el-col :span="3" style="line-height: 30px;margin-left: 2%">
          <span class="after-red">查体周期:</span>
        </el-col>
        <el-col :span="6">
          <el-select
            clearable
            ...
            @change="zqChange(modifySelection.physicalPeriod)"
          >
            <el-option v-for="item in examBody" :key="item.zoom" :value="item.zoom" :label="item.time"></el-option>
          </el-select>
        </el-col>
      </el-row>
      <el-row style="margin-top: 20px; margin-left:8.33333%">
        <div v-if="dkMorning">
          ...
          <el-col :span="7">
            <el-select
              clearable
              size="small"
              v-model="punchTime.morningValue"
            >
              <el-option
                v-for="item in punchTime.morning"
                :key="item.id"
                :value="item.id"
                :label="item.time"
              ></el-option>
        ...
        <div v-if="dkAfternoon">
          ...
          <el-col :span="7">
            <el-select
              clearable
              size="small"
              v-model="punchTime.afternoonValue"
            >
              <el-option
                v-for="item in punchTime.afternoon"
                :key="item.id"
                :value="item.id"
                :label="item.time"
              ></el-option>
      ...
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">查体设备:</span>
        </el-col>
        <el-col :span="6">
          <el-select size="small" clearable v-model="modifySelection.physicalDevice">
            <el-option v-for="item in examDevice" :key="item.zoom" :value="item.zoom" :label="item.type"></el-option>
          </el-select>
        </el-col>
        <el-col :span="3" style="line-height: 30px;margin-left:2%;">
          <span class="after-red">季&nbsp;&nbsp;&nbsp;&nbsp;度:</span>
        </el-col>
        <el-col :span="6">
          <el-select
            size="small"
      ...
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">衣服颜色:</span>
        </el-col>
        <el-col :span="6">
          <el-select
            clearable
          ...
          >
            <el-option v-for="item in dress" :key="item.zoom" :value="item.zoom" :label="item.color"></el-option>
          </el-select>
        </el-col>
        <el-col :span="3" style="line-height: 30px;margin-left: 2%">
          <span class="after-red">设备存放:</span>
        </el-col>
    <el-col :span="6" style="line-height: 30px;">
        <el-select  clearable size="small" v-model="sbStorage.sbStorageValue">
          <el-option
            v-for="item in sbStorage.select"
            :key="item.id"
            :value="item.id"
            :label="item.name"
          ></el-option>
      ...
      <el-row style="margin-top: 20px;">
        ...
        <el-col :span="3" style="line-height: 30px;margin-left:2%;">
          <span class="after-red">集合地点:</span>
        </el-col>
        <el-col :span="6">
          <el-select
            size="small"
            clearable
            v-model="jhdd.jhddValue"
          >
            <el-option v-for="item in jhdd.select" :key="item.id" :value="item.id" :label="item.name"></el-option>
          </el-select>
        </el-col>
      </el-row>
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">工作人员数:</span>
        </el-col>
        <el-col :span="6">
          <el-input v-model="modifySelection.needPhysicalCount" placeholder="请输入人数" size="small"></el-input>
        </el-col>
        <el-col :span="3" style="line-height: 30px;margin-left:2%;">
          <span class="after-red">查体开始时间</span>
        </el-col>
        <el-col :span="6">
          <el-date-picker
      ...
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">预估查体人数:</span>
        </el-col>
        <el-col :span="6">
          <el-input
        ...
        <el-col :span="3" style="line-height: 30px;margin-left:2%;">
          <span class="after-red">查体结束时间</span>
        </el-col>
        <el-col :span="6">
          <el-date-picker
      ...
      <el-row style="margin-top: 20px;">
        ...
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">日估查体人数:</span>
        </el-col>
        <el-col :span="6">
      ...
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2">
          <span class="after-red">是否需要车辆:</span>
        </el-col>
        ...
        <el-col :span="3">
          <span class="after-red">查体点安排表:</span>
        </el-col>
        <el-col :span="5" :offset="1">
          <el-radio v-model="isCtTable" label="1">有</el-radio>
          <el-radio v-model="isCtTable" label="2">无</el-radio>
        </el-col>
      </el-row>
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">是否开会:</span>
        </el-col>
        <el-col :span="5" :offset="1" style="line-height: 30px;">
          <el-radio v-model="isMeeting" label="1">是</el-radio>
          <el-radio v-model="isMeeting" label="2">否</el-radio>
        </el-col>
        <el-col :span="2" style="line-height: 30px;">
          <span class="after-red">反馈内容:</span>
        </el-col>
        <el-col :span="8" style="line-height: 30px;" >
          <el-checkbox-group v-model="modifySelection.feedBackContent">
            <el-checkbox label="十大病情彩页"></el-checkbox>
      ...
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">反馈方式:</span>
        </el-col>
        <el-col :span="6">
          <el-select
            clearable
            size="small"
            v-model="fkWay.fkWayValue"
            @change="fkWayChange(fkWay.fkWayValue)"
          >
            <el-option v-for="item in fkWay.select" :key="item.id" :value="item.id" :label="item.name"></el-option>
          </el-select>
        </el-col>
        <el-col v-if="fkShow" :span="5" :offset="2" style="line-height: 30px;">
          <el-radio v-model="isfkWay" label="1">校医</el-radio>
          <el-radio v-model="isfkWay" label="2">班主任</el-radio>
        </el-col>
        <el-col v-else :span="5" :offset="2" style="line-height: 30px;">
          <el-radio v-model="isfkWay" label="1">社区</el-radio>
          <el-radio v-model="isfkWay" label="2">学校</el-radio>
        </el-col>
      </el-row>
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
          <span class="after-red">工作内容:</span>
        </el-col>
        <el-col :span="14"  >
          <el-input
            type="textarea"
      ...
      <el-row class="foot_btn" style="margin-top:30px;">
        ...
        <el-col :span="4" :offset="1">
          <el-button style="width: 100%;" type="success" @click="modifySave()" size="middle">保存</el-button>
        </el-col>
      </el-row>
    </el-dialog>
    <!-- 新增弹框 -->
    ...
    >
      ...
      <el-row style="margin-top: 20px;">
        ...
        <el-col :span="6" >
          <el-input v-model="addNewList.linkPeople" disabled placeholder="自动获取" size="small"></el-input>
        </el-col>
        <el-col :span="3" style="line-height: 30px;margin-left: 2%">
          <span>对接人电话:</span>
        </el-col>
        <el-col :span="6" >
          <el-input v-model="addNewList.linkPhone" disabled placeholder="自动获取" size="small"></el-input>
        </el-col>
      </el-row>
      <el-row style="margin-top: 20px;">
        <el-col :span="3" :offset="2" style="line-height: 30px;">
        ...
        <el-col :span="6">
          <el-select
            ...
            @change="zqChange(addNewList.physicalPeriod)"
          >
            <el-option v-for="item in examBody" :key="item.zoom" :value="item.zoom" :label="item.time"></el-option>
          </el-select>
        </el-col>
      ...
      <el-row style="margin-top: 20px;">
        ...
        <el-col :span="6">
          <el-select size="small"  v-model="addNewList.physicalDevice">
            <el-option v-for="item in examDevice" :key="item.zoom" :value="item.zoom" :label="item.type"></el-option>
          </el-select>
        </el-col>
        <el-col :span="3" style="line-height: 30px;margin-left:2%;">
        ...
        <el-col :span="6">
          <el-select size="small" clearable  v-model="addNewList.quarter">
            <el-option v-for="item in season" :key="item.zoom" :value="item.zoom" :label="item.type"></el-option>
          </el-select>
        </el-col>
      </el-row>
      ...
      <el-row style="margin-top: 20px;">
        ...
        <el-col :span="6">
          <el-input v-model="addNewList.linkPeopleName" disabled placeholder="自动获取" size="small"></el-input>
        </el-col>
        <el-col :span="3" style="line-height: 30px;margin-left:2%;">
          <span class="after-red">集合地点:</span>
        </el-col>
      ...
      <el-row class="foot_btn" style="margin-top:30px;">
        ...
        <el-col :span="4" :offset="1">
          <el-button style="width: 100%;" type="success" @click="addOperation()" size="middle">保存</el-button>
        </el-col>
      </el-row>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      addNewList: {
        ...
        schedule : null,
        Ismeet: null,
        feedBackTypeFlag : null,
        feedBackType : null,
        pushCardTime:null,
        pushCardTimeEnd:null,
        venueplace:null,
      },
      // 查体周期
      examBody: [
  ...
  methods: {
    ...
    zqChange(id) {
      if (id == 1) {
        this.dkMorning = true;
        this.dkAfternoon = false;
      } else if (id == 2) {
        this.dkMorning = false;
        this.dkAfternoon = true;
      } else {
        this.dkMorning = true;
        this.dkAfternoon = true;
      }
    ...
    async getControlCommunities(pageIndex = 1, pageSize = 10) {
      ...
      if (this.search.quarter) {
        arg.whereLambda.quarter = this.search.quarter; //季度
      } else {
        arg.whereLambda.quarter = null;
      }

      if (this.search.isNeedCar) {
        arg.whereLambda.isNeedCar = this.search.isNeedCar; //是否需要车辆
      } else {
      ...
      if (this.search.feedbackContainer) {
        arg.whereLambda.feedbackContainer = this.search.feedbackContainer; //反馈内容
      } else {
        arg.whereLambda.feedbackContainer = null;
      }

      if (this.search.feedbackTypeValue) {
        arg.whereLambda.feedbackType = this.search.feedbackTypeValue; //反馈方式
      } else {
...
// console.log(arg)
    ...
    returnBtn() {
      ...
      this.addNewList.feedBackType = null;
      this.addNewList.feedBackContent = [];
      this.isDelete = 0;
      this.dkMorning=true;
      this.dkAfternoon=true;
      this.punchTime.afternoonValue=null;
      this.punchTime.morningValue=null;
      this.sbStorage.sbStorageValue=null;
      this.jhdd.jhddValue=null;
      this.fkWay.fkWayValue=null;
    },
    // 修改关闭按钮
    returnBtn2() {
    ...
    handleModify(row) {
      ...
      if (row.physicalPeriod) {
          if(row.physicalPeriod == "上午半天"){
              this.dkMorning=true
              this.dkAfternoon=false
          }else if(row.physicalPeriod == "下午半天"){
                this.dkMorning=false
                this.dkAfternoon=true
          }else if(row.physicalPeriod == "全天"){
              this.dkMorning=true
              this.dkAfternoon=true
          }
      }
      if (row.pushCardTimeEnd) {
        let pushCardTimeValue={
          "12:00":1,
          "12:30":2,
          "1:00":3,
          "1:30":4,
      ...
      this.punchTime.afternoonValue=pushCardTimeValue[row.pushCardTimeEnd];
      }
      if (row.pushCardTime) {
        let pushCardTimeValue={
          "8:00":1,
      ...
      this.punchTime.morningValue=pushCardTimeValue[row.pushCardTime];
      }
      if (row.feedBackType) {
      ...
      this.fkWay.fkWayValue=feedBackTypeValue[row.feedBackType];
      }
      if (row.feedBackTypeFlag) {
        if(this.fkWay.fkWayValue==1){
          let feedBackTypeFlagValue={
            "校医":"1",
            "班主任":"2",
          }
          this.isfkWay=feedBackTypeFlagValue[row.feedBackTypeFlag];
        }else{
          let feedBackTypeFlagValue={
            "社区":"1",
            "学校":"2",
      ...
      this.isNeedCar=isNeedCarValue[row.isNeedCar];
      }
      if (row.ismeet) {
        let ismeetValue={
          "是":"1",
      ...
      this.isMeeting=ismeetValue[row.ismeet];
      }
      if (row.venueplace) {
        let venueplaceValue={
          "社区门口":1,
      ...
      this.jhdd.jhddValue=venueplaceValue[row.venueplace];
      }
      if (row.deviceDeposit) {
      let ModifyDeviceDeposit={
        "放社区车上":1,
        "放下个幼儿园":2,
        "放社区":3,
        "4代表带回公司":4,
      }
      this.sbStorage.sbStorageValue=ModifyDeviceDeposit[row.deviceDeposit];
      }
      this.modifySelection.workContent = row.workContent;
      this.modifySelection.feedBackType = this.fkWay.fkWayValue;
      ...
      this.modifySelection.isNeedCar = this.isNeedCar;
      this.modifySelection.deviceDeposit = this.sbStorage.sbStorageValue;
    ...
    async modifySave() {
      ...
      if( this.sbStorage.sbStorageValue == null && !!this.jhdd.jhddValue == null){
        this.$message({
            type: "warning",
            message: "请正确填写表格信息！",
            center: true
      ...
      if (isString(modifyData.provice)) {
        allSelects = {
          ...
          ismeet:this.isMeeting,
          venueplace:this.jhdd.jhddValue,
          physicalDevice: this.modifySelection.physicalDevice,
          // pushCardTime: this.modifySelection.pushCardTime,
          pushCardTime : this.punchTime.morningValue,
          pushCardTimeEnd : this.punchTime.afternoonValue,
          ...
          feedBackType: this.fkWay.fkWayValue,
          ...
          deviceDeposit: this.sbStorage.sbStorageValue
        };
      } else {
        allSelects = {
          feedBackTypeFlag:this.isfkWay,
      ...
      if (dressColorResult) {
        ...
        allSelects.dressColor = this.modifySelection.dressColor;
      }
      //判断体检设备
      if (physicalDeviceResult) {
        ...
        allSelects.physicalDevice = this.modifySelection.physicalDevice;
      }
      ...
      if (physicalPeriodResult) {
        ...
        allSelects.physicalPeriod = this.modifySelection.physicalPeriod;
      }
      //判断季节
      if (quarterResult) {
        ...
        allSelects.quarter = this.modifySelection.quarter;
      }
    ...
    // 新增按钮
    addOperation() {
      // console.log(this.fkWay.fkWayValue)
      ...
      if (
        ...
        !!this.isMeeting &&
        !!this.isfkWay &&
        !!this.fkWay.fkWayValue &&
        !!this.sbStorage.sbStorageValue &&
        !!this.jhdd.jhddValue &&
        !!p.workContent &&
        // !!p.feedBackType &&
        ...
        addInfo.schedule = this.isCtTable;
        addInfo.Ismeet = this.isMeeting;
        addInfo.feedBackTypeFlag = this.isfkWay;
        addInfo.feedBackType = this.fkWay.fkWayValue;
        addInfo.deviceDeposit = this.sbStorage.sbStorageValue;
        addInfo.pushCardTime = this.punchTime.morningValue;
        addInfo.pushCardTimeEnd = this.punchTime.afternoonValue;
        addInfo.venueplace = this.jhdd.jhddValue;
        addInfo.dressColor = this.addNewList.dressColor;
        addInfo.isNeedCar = this.isNeedCar;
        // addInfo.pushCardTime = this.addNewList.pushCardTime.zoom;
        addInfo.quarter = this.addNewList.quarter;
        // addInfo.recordInfo = this.addNewList.recordInfo.zoom;
        // addInfo.deviceDeposit = this.radio;
        addInfo.physicalDevice = this.addNewList.physicalDevice;
        addInfo.physicalPeriod = this.addNewList.physicalPeriod;
