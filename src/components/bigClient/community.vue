        ...
        >
          ...
          >
            <el-col :span="2" style="width: 8.1%;line-height: 30px;margin-left: 10%;">
              <span class="after-red">对接人姓名:</span>
            </el-col>
            <el-col :span="4" >
            ...
            <el-col :span="2" style="width: 9%;line-height: 30px;margin-left: 1.9%">
              <span class="after-red">对接人电话:</span>
            </el-col>
            <el-col :span="4" >
            ...
            <el-col :span="2" style="width: 6%;line-height: 30px;margin-left:10%;">
              ...
              <el-col :span="3">
                <el-select
                  ...
                  size="small"
                  value-key="countyId"
                  v-model="modifySelection.siteId"
                >
                  <el-option
                    v-for="item in siteList"
                    :key="item.id"
...
export default {
  ...
  methods: {
    ...
    async saveCommunity() {
      ...
      self.allData.sysuId = self.siteId;
    ...
    handleModify(row) {
      ...
      this.modifySelection.siteId = row.hospitalId;
    ...
    async modifySave() {
      ...
      if (isString(modifyData.province)) {
        allSelects = {
          ...
          sysuId: this.modifySelection.siteId
        };
      } else {
        allSelects = {
