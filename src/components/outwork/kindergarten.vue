<template>
  ...
  <div class="container" style="height: 800px;overflow-y: scroll">
    <el-row style="border-bottom: 1px solid #EBEEF5;padding-bottom: 16px;">
      <el-row>
        ...
        <el-col :span="2" style="width:120px">
          <el-select size="small" style="width:100%" :clearable="true" v-model="search.illness">
    ...
    <el-row style="margin-top:20px;">
      <el-col :span="2" class="first-text-four">查体时间:</el-col>
      <el-col :span="5">
        <el-date-picker
    ...
    >
      ...
      <el-row style="margin-top: 30px;">
        ...
        <el-col :span="3">
          ...
          >
            <el-option
              v-for="(item,index) in schoolGrade"
              :key="index"
      ...
      >
        ...
        <el-col :span="3">
          <el-select
            ...
            @change="getClass(inputData.school.schoolId)"
          >
            <el-option
      ...
      <el-row class="foot_btn">
        ...
        <el-col :span="3" :offset="1">
          <el-button style="width: 100%;" type="danger" size="middle" @click="endInput()">结束本次录入</el-button>
        </el-col>
      </el-row>
    </el-dialog>
    ...
    >
      ...
      >
        ...
        <el-col :span="2" style="text-align: left;width: 7%;">
          <el-select size="small" :clearable="true" value-key="zoom" v-model="modifyData.quarter">
            <el-option
              v-for="item in season"
              :key="item.zoom"
              :value="item.zoom"
      ...
      <el-row style="margin-top: 30px;">
        ...
        <el-col :span="3">
          ...
          <el-select
            :clearable="true"
            size="small"
            v-model="modifyData.className"
            @change="getTeacher('修改')"
          >
            <el-option
              v-for="(item,index) in schoolGrade"
              :key="index"
      ...
      >
        ...
        <el-col :span="3">
          <el-select
            ...
            @change="getClass(modifyData.schoolName.schoolId)"
          >
            <el-option
    ...
    <el-row class="client_table" style="min-height: 580px;">
      <el-col :span="24">
        ...
        >
          ...
          <el-table-column align="center" prop="bak" label="并发症" min-width="100">
            <template slot-scope="scope">
              <span>{{scope.row.bak || "无数据"}}</span>
            </template>
          </el-table-column>
  ...
  methods: {
    ...
    getCountyId(item, type) {
      ...
      if (item) {
        ...
        try {
          return new Promise((resolve, reject) => {
            getOutCommunity({ countyId: countyVal, physicalType: 1 })
              .then(res => {
                if (res.data.Error) {
                  this.$message({
                    type: "warning",
    ...
    getClass(id) {
      ...
      getSchool({ schoolId: id })
        .then(res => {
          debugger;
          this.schoolGrade = res.data.ResponseModel[0].teachers || null;
        })
        .catch(err => {
          console.log(err);
        });
    ...
    getTeacher(xugai) {
      debugger;
      if (xugai == "修改") {
        if (!!this.modifyData.className && !!this.modifyData.grade) {
          let data = {
            schoolId: this.schoolGrade[0].schoolId,
            gradeName: this.modifyData.grade,
            className: this.modifyData.className
          };
          GetTeachers(data)
            .then(res => {
              debugger;
              this.modifyData.teacherName =
                res.data.ResponseModel[0].teachers[0].teacherName || null;
              this.modifyData.teacherTel =
                res.data.ResponseModel[0].teachers[0].teacherTel || null;
            })
            .catch(err => {
              console.log(err);
            });
        ...
        if (!!this.inputData.className && !!this.inputData.grade) {
          let data = {
            schoolId: this.schoolGrade[0].schoolId,
            gradeName: this.inputData.grade,
            className: this.inputData.className
          };
          GetTeachers(data)
            .then(res => {
              this.inputData.teacherName =
                res.data.ResponseModel[0].teachers[0].teacherName || null;
              this.inputData.teacherPhone =
                res.data.ResponseModel[0].teachers[0].teacherTel || null;
            })
            .catch(err => {
              console.log(err);
    ...
    handleprogre(event, file, fileList) {},
    ...
    handleOrder(item) {
      ...
      if (item) {
        ...
        if (item.result == "是") {
          this.modifyData.illnessList.push("足弓发育不良");
        }
      }
    },
    ...
    saveInputData(type) {
      ...
      if (type === "input") {
        ...
        inputDatas = {
          ...
          quarter: allData.quarter,
          physicalTime: examTimeData,
        ...
        let xinbian = allData.sex == "男" ? 1 : allData.sex == "女" ? 2 : null;
        console.log(allData);
        //第一步 验证是否为空
        debugger;
        if (
        ...
        inputDatas.physicalTime = allData.examTime;
