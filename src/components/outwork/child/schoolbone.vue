  ...
  <div class="container" style="height: 750px;overflow-y: scroll">
        ...
        <el-row>
          ...
          <el-col :span="2">
            <el-select size="small" :clearable="true" value-key="zoom" v-model="search.isDiff">
              <el-option v-for="item in isDiff" :key="item.zoom" :value="item" :label="item.type"></el-option>
            </el-select>
          </el-col>
        </el-row>
      </el-col>
    ...
    <el-row style="margin-top:20px;">
      ...
      <el-col :span="2" class="top-schear-but">
        <el-button style="width: 100%;" @click="searchData()" type="success" size="small">查询</el-button>
      </el-col>
      <el-col :span="2" class="top-schear-but">
      ...
      <el-col :span="2" class="top-schear-but">
        <el-button type="success" size="small" style="width:100%" @click="InputdialogVisible = true">录入数据</el-button>
      </el-col>
...
export default {
  ...
  data() {
    return {
      ...
      //是否异常
      isDiff: [{ type: "是", zoom: 1 }, { type: "否", zoom: 2 }],
      //体检时间
      examTime: null,
      //录入时间
      inputTime: null,
  ...
  methods: {
    ...
    outExcel() {
      ...
      // let baseUrl = 'http://192.168.3.220:83/api/Userphysical/ExportOutUserphysicals';//测试
      let baseUrl = 'http://192.168.3.220:83/api/UserphysicalForSchool/ExportOutUserphysicals';//上线
