...
export default {
  ...
  methods: {
    ...
    outExcel() {
      ...
      // let baseUrl = 'http://117.34.105.87:88/api/Userphysical/ExportOutUserphysicals';//测试
      let baseUrl =pathUrl.pathUrl_net+ '/api/UserphysicalForSchool/ExportOutUserphysicals';//上线
